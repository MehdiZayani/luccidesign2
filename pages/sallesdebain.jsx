            ...
            <div className={styles.salledebain}>
                ...
                <div className={styles.section1}>
                    <div className={styles.card1}>
                        ...
                        <Image src={salledebain} className={styles.image1} alt='Meuble salle de bains' />
                        <Image src={salledebain3} className={styles.image2} alt='Meuble salle de bains'/>
                    </div>
                    <div className={styles.card2}>
                        <Image src={salledebain2} className={styles.image1} alt='Meuble salle de bains'/>
                ...
                <div className={styles.section1}>
                    <div className={styles.card2}>
                        <Image src={salledebain4} className={styles.image1} alt='Meuble salle de bains'/>
                    ...
                    <div className={styles.card1}>
                        ...
                        <Image src={salledebain5} className={styles.image1} alt='Meuble salle de bains'/>
                    </div>
                </div>
                <div className={styles.section1}>
                    <div className={styles.card1}>
                        <p className={styles.sectitle}>EMMA</p>
                        <Image src={salledebain6} className={styles.image4} alt='Meuble salle de bains'/>
                    </div>
                    <div className={styles.card2}>
                        <Image src={salledebain7} className={styles.image1} alt='Meuble salle de bains'/>
                ...
                <div className={styles.section1}>
                    <div className={styles.card2}>
                        <Image src={salledebain8} className={styles.image1} alt='Meuble salle de bains'/>
                        <p className={styles.cardpara}>Eli vous offre un plateau entièrement en pierre décorative parmi lesquelles vous retrouverez le marbre, le travertin, la céramique … Avec la salle de bain adonis, un large choix de vasque accordés aux finitions des tiroir s’offrent à vous. Sans poignées, ses meubles vous offrent un design sans pareil. D’une profondeur de 50cm, 5 coloris mat et 6 plateau en pierre décorative sont disponibles.</p>
                    </div>
                    <div className={styles.card1}>
                        <p className={styles.sectitle}>ELI</p>
                        <Image src={salledebain9} className={styles.image1}  alt='Meuble salle de bains'/>
                        <Image src={salledebain10} className={styles.image3} alt='Meuble salle de bains' />
                ...
                <div className={styles.section1}>
                    <div className={styles.card1}>
                        ...
                        <Image src={salledebain11} className={styles.image4} alt='Meuble salle de bains'/>
                    </div>
                    <div className={styles.card2}>
                        <Image src={salledebain12} className={styles.image1} alt='Meuble salle de bains'/>
