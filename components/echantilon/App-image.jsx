            ...
            <ul className="px-3 relative pb-3 flex">
              <li className="flex items-center text-gray-900 text-sm sm:text-lg py-4">
                <span className="text-gray-400 ml-2">
                  <svg
                    className={`w-7 h-7 ${activeCategory === 'All' ? 'text-red-600 ' : ''}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                ...
                <button
                  className={`btn btn-primary ${activeCategory === 'All' ? 'active text-red-600 border-b-4 border-red-600' : ''}`}
                  onClick={allItem}
                >
                  All
                </button>
              ...
              <li className="flex items-center text-gray-900 text-sm sm:text-lg py-4">
                <span className="text-gray-400 ml-2">
                  <svg
                    className={`w-6 h-6 ${activeCategory === 'highgloss' ? 'text-red-600 ' : ''}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <button
                  className={`btn btn-primary ${activeCategory === 'highgloss' ? 'active text-red-600 border-b-4 border-red-600' : ''}`}
              ...
              <li className="flex items-center text-gray-900 text-sm py-4 sm:text-lg">
                <span className="text-gray-400 ml-2">
                  <svg
                    className={`w-6 h-6 ${activeCategory === 'digitalpolylac' ? 'text-red-600 ' : ''}`}
                    fill={`${activeCategory === 'digitalpolylac' ? "#DC2626" : 'none'}`}
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                <button
                  className={`btn btn-primary ${activeCategory === 'digitalpolylac' ? 'active text-red-600 border-b-4 border-red-600' : ''}`}
...
{/*               <li className="flex items-center text-gray-900 text-sm py-4 sm:text-lg">
                <span className="text-gray-400 ml-2 ">
                  <svg
                    className={`w-6 h-6 ${activeCategory === 'React' ? 'text-red-600' : ''}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <button
                  className={`btn btn-primary ${activeCategory === 'React' ? 'active text-red-600 border-b-4 border-red-600' : ''}`}
              ...
              <li className="flex items-center text-gray-900 text-sm py-4 sm:text-lg ">
                <span className="text-gray-400 ml-2">
                  <svg
                    className={`w-6 h-6 ${activeCategory === 'mélaminé' ? 'text-red-600 ' : ''}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <button
                  className={`btn btn-primary ${activeCategory === 'mélaminé' ? 'active text-red-600 border-b-4 border-red-600' : ''}`}
